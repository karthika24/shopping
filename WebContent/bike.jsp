...
<body>
	...
	<div class="form">
		<form action="ViewServlet" method="post">
			<table>
				<tbody>
					<c:forEach var="showbikes" items="${Bike}">
						<tr>
							<td>${showbikes.name }</td>
							<td>${showbikes.model }</td>
							<td>${showbikes.price }</td>
							<td><button type="submit" name="bike"
									value="${showbikes.name }">View</button>
						</tr>
					</c:forEach>
				</tbody>
			</table>
			<!-- <button type="submit" name="bike" value="Royal Enfield">Royal
				Enfield</button>
			<br>
			<button type="submit" name="bike" value="KTM">KTM</button>
			<br>
			<button type="submit" name="bike" value="Honda">Honda</button> -->
		</form>
	</div>
</body>
</html>